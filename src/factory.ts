...
export function handlePairCreated(event: PairCreated): void {
  ...
  if (token0 === null) {
    ...
    token0.trackedTotalLiquidity = ZERO_BD;
    token0.trackedTotalLiquidityUSD = ZERO_BD;
    token0.save();
  }
  ...
  if (token1 === null) {
    ...
    token1.trackedTotalLiquidity = ZERO_BD;
    token1.trackedTotalLiquidityUSD = ZERO_BD;
    token1.save();
  }
